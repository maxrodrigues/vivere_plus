            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="pr-5">
                        ...
                        <a href="#galery" class="btn btn-light btn-rounded text-3 font-weight-bold mr-3" style="color: #2c247b">
            ...
            <div class="row">
                ...
                <div class="mt-4 pt-2 lightbox" data-plugin-options="{'delegate': 'a', 'type': 'image', 'gallery': {'enabled': true}}">
                    <div class="row portfolio-list sort-destination" data-sort-id="portfolio">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 isotope-item">
                            <div class="portfolio-item">
                                <a href="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-1-2-md.jpg') }}">
                                    <span class="thumb-info thumb-info-lighten border-radius-0">
                                        <span class="thumb-info-wrapper border-radius-0">
                                            <img src="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-1-2-md.jpg') }}" class="img-fluid border-radius-0" alt="">
                                        </span>
                                    </span>
                                </a>
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 isotope-item">
                            <div class="portfolio-item">
                                <a href="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-3-4-md.jpg') }}">
                                    <span class="thumb-info thumb-info-lighten border-radius-0">
                                        <span class="thumb-info-wrapper border-radius-0">
                                            <img src="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-3-4-md.jpg') }}" class="img-fluid border-radius-0" alt="">
                                        </span>
                                    </span>
                                </a>
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 isotope-item">
                            <div class="portfolio-item">
                                <a href="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-5-6-md.jpg') }}">
                                    <span class="thumb-info thumb-info-lighten border-radius-0">
                                        <span class="thumb-info-wrapper border-radius-0">
                                            <img src="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-5-6-md.jpg') }}" class="img-fluid border-radius-0" alt="">
                                        </span>
                                    </span>
                                </a>
                            </div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-3 isotope-item">
                            <div class="portfolio-item">
                                <a href="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-7-8-md.jpg') }}">
                                    <span class="thumb-info thumb-info-lighten border-radius-0">
                                        <span class="thumb-info-wrapper border-radius-0">
                                            <img src="{{ asset('img/pairs/galwan/empreendimentos/mar-dourado/plantas/coluna-7-8-md.jpg') }}" class="img-fluid border-radius-0" alt="">
                                        </span>
                                    </span>
                                </a>
                            </div>
                        ...
                        <div class="col-12">
                            <form class="contact-form" action="{{ route('contact-us.sendMail') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Nome" style="border-radius: 0; height: 50px; padding: 10px; font-size: 15px; color: #777;">
                                </div>
                                <div class="form-group">
                                    <input type="tel" name="phone" id="phone" class="form-control" placeholder="Telefone" style="border-radius: 0; height: 50px; padding: 10px; font-size: 15px; color: #777;">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" id="email" class="form-control" placeholder="E-mail" style="border-radius: 0; height: 50px; padding: 10px; font-size: 15px; color: #777;">
                                </div>
                                <div class="form-group">
                                    <textarea name="message" id="message" cols="30" rows="10" placeholder="Mensagem" class="form-control" style="border-radius: 0; padding: 10px; font-size: 15px; color: #777;"></textarea>
                                </div>
