                                        ...
                                        <div class="es-property-inner">
                                                ...
                                                <div class="es-thumbnail">
                                                    <a href="index.html%3Fp=6953.html">
                                                        ...
                                                        <ul class="es-property-label-wrap">
                                                            <li class="es-property-label es-property-label-open-house" style="color:#2bbe0e">{{ $property->typeImmobile->name }}</li><br>
                                                        </ul>
                                            ...
                                            <div class="es-property-info">
                                                <div class="es-row-view">
                                                    <h2>
                                                        <a href="index.html%3Fp=6953.html">{{ $property->name }}</a>
                                                        <span class="es-price">{{ $formatter->formatCurrency($property->price, 'BRL') }}</span>
                                                    </h2>
                                                </div>
                                                <div class="es-col-view">
                                                    <h2>
                                                        <a class="es-property-link" href="index.html%3Fp=6953.html">{{ $property->name }}</a>
                                                    </h2>
                                                    <span class="es-price">{{ $formatter->formatCurrency($property->price, 'BRL') }}</span>
                                                </div>
                                                ...
                                                <div class="es-bottom-info">
                                                    <div class="es-bottom-icon-cols">
                                                        <span class="es-bottom-icon">
                                                            <i class="es-icon es-squirefit" aria-hidden="true"></i>
                                                            {{ $property->area }} m²
                                                        </span>
                                                        <span class="es-bottom-icon">
                                                            <i class="es-icon es-bed" aria-hidden="true"></i>
                                                            {{ $property->bedrooms }} Quartos
                                                        </span>
                                                        <span class="es-bottom-icon">
                                                            <i class="es-icon es-bath" aria-hidden="true"></i>
                                                    ...
                                                    <div class="es-details-wrap es-details-no-padding">
                                                        <div class="es-details-flex">
                                                            <div class="es-map-link-wrap">
                                                                <a href="javascript:void(0)" class="es-map-view-link es-hover-show" data-longitude="-40.3273357" data-latitude="-20.3858509">Ver no Mapa</a>
                                                            </div>
                                                            <span class="es-read-wrap">
                                                                <a href="{{ route('buildings.details', ['slug' => $property->slug]) }}" class="es-button es-button-orange es-hover-show es-read">Detalhes</a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
