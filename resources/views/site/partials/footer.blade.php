    ...
    <div class="container">
        <div class="row py-5">
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                ...
                <ul class="list">
                    <li class="mb-1"><a href="javascript:void(0)">Despachante e Serviços Cartoriais</a></li>
                    <li class="mb-1"><a href="javascript:void(0)">International</a></li>
                    <li class="mb-1"><a href="javascript:void(0)">Financiamento</a></li>
                    <li class="mb-1"><a href="javascript:void(0)">Parceiros</a></li>
                    <li class="mb-1"><a href="javascript:void(0)">Contratando uma corretora de imóveis</a></li>
                    <li class="mb-1"><a href="javascript:void(0)">Sustentabilidade</a></li>
                </ul>
            </div>
            <div class="col-md-6 col-lg-2">
                ...
                <ul class="footer-social-icons social-icons m-0">
                    ...
                    <li class="social-icons-instagram"><a href="https://www.instagram.com/" target="_blank" title="Instagram"><i class="fab fa-instagram text-2"></i></a></li>
                </ul>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <h5 class="text-3 mb-3">NEWSLETTER</h5>
                <div class="alert alert-danger d-none" id="newsletterError"></div>
                <form id="newsletterForm" action="php/newsletter-subscribe.php" method="POST" class="me-4 mb-3 mb-md-0" novalidate="novalidate">
            ...
            <div class="row py-4">
                <div class="col-lg-2 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
                    <a href="index.html" class="logo pe-0 pe-lg-3">
                        <img alt="Porto Website Template" src="img/logo-branca-pequena.png" class="opacity-5" height="32">
                    </a>
                </div>
