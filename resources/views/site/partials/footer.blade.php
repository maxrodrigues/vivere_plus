        ...
        <div class="row py-5">
            <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
                ...
                <ul class="list list-icons list-icons-lg">
                    ...
                    <li class="mb-1"><i class="fab fa-whatsapp text-color-primary"></i><p class="m-0"><a href="tel:+5527997333555">+55 (27) 997 333 555</a></p></li>
                    <li class="mb-1"><i class="fab fa-whatsapp text-color-primary"></i><p class="m-0"><a href="tel:+5527999732004">+55 (27) 999 732 004</a></p></li>
            ...
            <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                ...
                <ul class="list">
                    ...
                    <li class="mb-1"><a href="{{ route('broker') }}">Cuidados na relação comercial</a></li>
