<header id="header" class="header-transparent header-transparent header-transparent-dark"
                            ...
                            <div
                                ...
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        <li class="dropdown">
                                            <a class="dropdown-item dropdown-toggle @if ($active == 'home') active @endif"
                                                href="{{ route('home') }}">
                                                Home
                                            </a>
                                        </li>
                                        <li class="dropdown dropdown-mega">
                                            <a class="dropdown-item dropdown-toggle @if ($active == 'about') active @endif"
                                                href="{{ route('about') }}">
                                                A Vivere
                                            </a>
                                        </li>
